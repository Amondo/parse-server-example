...
class MailgunAdapter extends MailAdapter {
    ...
    _sendMail(options) {
        ...
        const args = { templateVars: templateVars, message: message, selectedTemplate: selectedTemplate };
    ...
    *_mailGenerator(args) {
        let compiled;
        var _args$selectedTemplat = args.selectedTemplate;
        let template = _args$selectedTemplat.config,
            templateName = _args$selectedTemplat.name;
